...
const Login = ({ setToken  }) => {
  ...
  const handleLogin = async (event: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const {status, data } = await axios.post('http://localhost:3000/api/doctors/signin', info);
      console.log (data)
    ...
    navigate("/"); 
      ...
      if (error.response) {
        ...
        // No response was received or there was an error in the request setup
  ...
  return (
    ...
    <div className="grid grid-cols-[1fr_2fr] ">
      ...
      <div className="flex justify-center items-center">
          <form className="w-[400px] mx-auto p-[30px] rounded-md shadow-lg" onSubmit={handleLogin}>
